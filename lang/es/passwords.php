...
return [
    ...
    | que son dadas por el recuperador de contraseñas para un intento de actualización de contraseña
    | ha fallado, como por ejemplo, para un token inválido o una nueva contraseña inválida.
    |
    */
